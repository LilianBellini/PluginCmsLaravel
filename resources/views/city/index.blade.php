        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <span class="text-gray-500 mt-1 fw-semibold fs-6">Liste de vos Villes</span>
                </div>
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    <div class="d-flex">
                        <a href="{{ route('admin.page.city.create') }}"
                    ...
                    <div class="card-body pt-6">
                                        ...
                                        <tr>
                                            <td class="text-start">
                                                <span class="text-gray-800 fw-bold fs-6">
                                                    {{ $city->translations->firstWhere('locale', 'fr')->name ?? 'Nom non disponible' }}
                                                </span>
                                            </td>
                                            <td class="text-end">
                                                <div class="d-inline-flex">
                                                    <a href="{{ route('admin.page.city.edit', $city->id) }}"
                                                        class="btn btn-info btn-sm me-1">
                                                        <i class="bi bi-pencil-square"></i>
                                                    </a>
                                                    <form method="POST"
                                                        action="{{ route('admin.page.city.destroy', $city->id) }}"
                        ...
                        <div class="d-flex flex-stack flex-wrap pt-10">
                            <div class="fs-6 fw-semibold text-gray-700">
                                Affichage de {{ $cities->firstItem() }} à {{ $cities->lastItem() }} sur
                                {{ $cities->total() }} entrées
                            </div>
                            @if ($cities->hasPages())
                                <ul class="pagination">
                                    ...
                                    @else
                                        <li class="page-item">
                                            <a href="{{ $cities->previousPageUrl() }}" class="page-link"><i
                                                    class="previous"></i></a>
                                        </li>
                                    @endif
                                    ...
                                    @if ($cities->hasMorePages())
                                        <li class="page-item">
                                            <a href="{{ $cities->nextPageUrl() }}" class="page-link"><i class="next"></i></a>
                                        </li>
                                    @else
                                        <li class="page-item disabled">
