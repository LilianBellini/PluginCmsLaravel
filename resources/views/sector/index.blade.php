        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <span class="text-gray-500 mt-1 fw-semibold fs-6">Liste de vos Secteurs</span>
                </div>
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    <div class="d-flex">
                        <a href="{{ route('admin.page.sector.create') }}"
                    ...
                    <div class="card-body pt-6">
                                        ...
                                        <tr>
                                            <td class="text-start">
                                                <span class="text-gray-800 fw-bold fs-6">
                                                    {{ $sector->translations->firstWhere('locale', 'fr')->name ?? 'Nom non disponible' }}
                                                </span>
                                            </td>
                                            <td class="text-end">
                                                <div class="d-inline-flex">
                                                    <a href="{{ route('admin.page.sector.edit', $sector->id) }}"
                                                        class="btn btn-info btn-sm me-1">
                                                        <i class="bi bi-pencil-square"></i>
                                                    </a>
                                                    <form method="POST"
                                                        action="{{ route('admin.page.sector.destroy', $sector->id) }}"
                        ...
                        <div class="d-flex flex-stack flex-wrap pt-10">
                            <div class="fs-6 fw-semibold text-gray-700">
                                Affichage de {{ $sectors->firstItem() }} à {{ $sectors->lastItem() }} sur
                                {{ $sectors->total() }} entrées
                            </div>
                            @if ($sectors->hasPages())
                                <ul class="pagination">
                                    ...
                                    @else
                                        <li class="page-item">
                                            <a href="{{ $sectors->previousPageUrl() }}" class="page-link"><i
                                                    class="previous"></i></a>
                                        </li>
                                    @endif
                                    @foreach ($sectors->links()->elements as $element)
                                    ...
                                    @if ($sectors->hasMorePages())
                                        <li class="page-item">
                                            <a href="{{ $sectors->nextPageUrl() }}" class="page-link"><i class="next"></i></a>
                                        </li>
                                    @else
                                        <li class="page-item disabled">
